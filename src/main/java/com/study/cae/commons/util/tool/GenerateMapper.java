...
public class GenerateMapper {
    ...
    public static void getMapperFile(String tableName, int subNum, String packageName) {
        ...
        String fileName = dirName + "/" + entityClassName + "Mapper.java";// 创建文件
        ...
        builder.append("public interface " + entityClassName + "Mapper {" + "\r\n\r\n");
        ...
        if ("varchar(32)".equalsIgnoreCase(keyType)) {
            builder.append("	public int deleteByPrimaryKey(@Param(\"" + keyNameEntity + "\") String " + keyNameEntity + ");" + "\r\n\r\n");
            ...
            builder.append("	public int deleteByPrimaryKey(@Param(\"" + keyNameEntity + "\") Long " + keyNameEntity + ");" + "\r\n\r\n");
            builder.append("	public " + entityClassName + " selectByPrimaryKey(@Param(\"" + keyNameEntity + "\")Long " + keyNameEntity + ");" + "\r\n\r\n");
        } else {
            builder.append("	public int deleteByPrimaryKey(@Param(\"" + keyNameEntity + "\") Integer " + keyNameEntity + ");" + "\r\n\r\n");
